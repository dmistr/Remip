...
<a name="режим-управление-пк"></a>
### РЕЖИМ «УПРАВЛЕНИЕ ПК»

<a name="ip-и-учётные-данные"></a>
#### IP и учётные данные
...
**Полноэкранный режим (FullscreenScreenshotDialog):**
...
<a name="удалённое-управление-phantom-input"></a>
...
<a name="расширенная-настройка"></a>
...
<a name="платформа-умного-агента"></a>
...
<a name="phantom-input--протокол-и-реализация"></a>
